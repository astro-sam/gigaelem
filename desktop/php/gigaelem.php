					...
					<fieldset>
						<div class="col-lg-7">
							...
							<div class="form-group" id="tuileytpe">
								<label class="col-sm-3 control-label" > {{Type de la tuile}}
									<sup><i class="fas fa-question-circle tooltips" title="Bascule entre l'affichage Jeedom et un affichage personnalisé"></i></sup>
...
<?php include_file('desktop', 'gigaelem', 'js', 'gigaelem');?>
